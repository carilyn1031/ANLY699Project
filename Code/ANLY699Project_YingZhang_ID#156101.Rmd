...
co2Concentration.plot <- ggplot(compositeCO2record,aes(Age.yrBP,CO2.ppmv))+geom_line()+labs(title="CO2 Concentration 0-800 kyr Before Present",x="Year before present", y="CO2 concentration (ppmv)")
...
CD1980to2017.plot <- ggplot(CD1980to2017, aes(year,mean)) + geom_line()+ labs(title="CO2 Concentration 1980-2017",x="Year", y="CO2 concentration (ppmv)")
CD1980to2017.plot
...
GHGEmission.plot <- ggplot(GHG_EmissionByGas,aes(x=Year,y=Emission, fill=Gas))+geom_bar(position="stack", stat = "identity")+labs(title="Global GHG Emission by Gas 1960-2014",x="Year",y="CO2 Emission")
GHGEmission.plot
...
GHGEmissionBySector.plot <- ggplot(GHG_EmissionBySector,aes(x=Year,y=Emission, fill=Sector))+geom_bar(position="stack", stat = "identity")+labs(title="Global GHG Emission by Sector 1990-2010",x="Year",y="CO2 Emission")
