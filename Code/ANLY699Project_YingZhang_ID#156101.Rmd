...
GHGEmission.plot <- ggplot(GHG_EmissionByGas,aes(x=Year,y=Emission, fill=Gas))+geom_bar(position="stack", stat = "identity")+labs(title="GHG Emission by Gas 1960-2014",x="Year",y="CO2 Emission")
GHGEmission.plot
